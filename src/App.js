...
const SHEET_API_URL = `https://docs.google.com/spreadsheets/d/${SHEET_ID}/gviz/tq?tqx=out:json&headers=1&sheet=${encodeURIComponent(SHEET_NAME)}`;
      ...
      {currentPage === 'add' ? (
        ...
        <main className="app-container">
          ...
          <section className="list-toolbar">
            <button type="button" className="primary-button" onClick={() => setCurrentPage('add')}>
              Add product
            </button>
          </section>
